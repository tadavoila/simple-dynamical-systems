...
def plot_variances(all_variances, values, var_type='Regular'):
    ...
    fig.update_layout(
        title=f'Average {var_type} for Bins 1-6 and Bins 7-12 over Iterations (k >= 510)',
    ...
    py.plot(fig, filename=f'Siddharth Decay/Siddharth Decay Charts/{var_type.lower()}_plot_avg_2bins_kge510.html')
