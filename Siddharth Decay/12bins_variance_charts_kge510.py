...
def plot_variances(all_variances, values, var_type='Regular'):
    ...
    fig.update_layout(
        title=f'{var_type} for All Bins over Iterations (k >= 510)',
    ...
    py.plot(fig, filename=f'Siddharth Decay/Siddharth Decay Charts/12bins_{var_type.lower()}_subplots_kge510.html')
