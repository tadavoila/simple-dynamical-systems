...
def plot_variances(all_variances, values, var_type='Regular'):
    ...
    fig.update_layout(
        title=f'Average Variance Difference for Bins 1-6 and Bins 7-12 over Iterations (k >= 110)',
    ...
    py.plot(fig, filename=f'Siddharth Decay/Siddharth Decay Charts/var_difference_plot_avg_2bins_kge110.html')
