...
# check first value saved and check initial variance sameness
# subtract say 1-1/70 for 7-12 and 1-6 and check behavior difference curve and also individually (both var and mean)
