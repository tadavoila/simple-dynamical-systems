...
# Initialize a dictionary to store slopes for each k value
slope_dict = {}

# Pattern to extract the k value from file names
...
# Step 3: Plot the average slopes vs. k values
...
fig.update_layout(
    ...
    xaxis_title='Transformed Decay Rate (1/(1-k))',
    yaxis_title='Average Slope of Difference Curve',
    xaxis=dict(
        tickmode='auto',  # Let Plotly decide the tick values
        type='linear'  # Keep the axis type linear
    )
)
